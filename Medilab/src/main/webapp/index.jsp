...
<!-- Fav_Icons -->
<link href="External/img/favicon.png" rel="icon">
<link href="External/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<body>
	...
	<div id="topbar" class="d-flex align-items-center fixed-top">
		<div class="container d-flex justify-content-between">
			<div class="contact-info d-flex align-items-center">
				<i class="bi bi-envelope"></i> <a href="">contact@example.com</a> <i
					class="bi bi-phone"></i> +1 5589 55488 55
			</div>
			<div class="d-none d-lg-flex social-links align-items-center">
				<a href="https://twitter.com/" class="twitter"><i
					class="bi bi-twitter"></i></a> <a href="https://facebook.com/"
					class="facebook"><i class="bi bi-facebook"></i></a> <a
					href="https://instagram.com/" class="instagram"><i
					class="bi bi-instagram"></i></a> <a href="https://linkedin.com/"
	...
	<header id="header" class="fixed-top">
		<div class="container d-flex align-items-center">
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					<li><a class="nav-link active" href="#welcome">Home</a></li>
				...
				<div class="col-lg-4 d-flex align-items-stretch">
					<div class="content">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
							...
							aliqua. Duis aute irure dolor in reprehenderit Asperiores dolores
							sed et. Tenetur quia eos. Autem tempore quibusdam vel
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 mt-5 mt-md-0">
					<div class="count-box">
						<i class="far fa-hospital"></i> <span>18</span>
						<p>Departments</p>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
					<div class="count-box">
						<i class="fas fa-flask"></i> <span>12</span>
						<p>Research Labs</p>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
					<div class="count-box">
						<i class="fas fa-award"></i> <span>150</span>
						<p>Awards</p>
					</div>
				</div>
				...
				<div class="col-lg-3">
					<ul class="nav nav-tabs flex-column">
						...
						<li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
							href="#tab-2">Neurology</a></li>
						<li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
							href="#tab-3">Hepatology</a></li>
						<li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
							href="#tab-4">Pediatrics</a></li>
						<li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
							href="#tab-5">Eye Care</a></li>
					</ul>
				</div>
					...
					<div class="tab-content">
						<div class="tab-pane active show" id="tab-1">
							<div class="row">
								...
								<div class="col-lg-4 text-center order-1 order-lg-2">
									<img src="External/img/departments-1.jpg" alt=""
										class="img-fluid">
								</div>
							</div>
						</div>
						<div class="tab-pane" id="tab-2">
							<div class="row">
								...
								<div class="col-lg-4 text-center order-1 order-lg-2">
									<img src="External/img/departments-2.jpg" alt=""
										class="img-fluid">
								</div>
							</div>
						</div>
						<div class="tab-pane" id="tab-3">
							<div class="row">
								...
								<div class="col-lg-4 text-center order-1 order-lg-2">
									<img src="External/img/departments-3.jpg" alt=""
										class="img-fluid">
								</div>
							</div>
						</div>
						<div class="tab-pane" id="tab-4">
							<div class="row">
								...
								<div class="col-lg-4 text-center order-1 order-lg-2">
									<img src="External/img/departments-4.jpg" alt=""
										class="img-fluid">
								</div>
							</div>
						</div>
						<div class="tab-pane" id="tab-5">
							<div class="row">
								...
								<div class="col-lg-4 text-center order-1 order-lg-2">
									<img src="External/img/departments-5.jpg" alt=""
										class="img-fluid">
								</div>
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="member d-flex align-items-start">
						<div class="pic">
							<img src="External/img/doctors/doctors-1.jpg" class="img-fluid"
								alt="">
						</div>
				...
				<div class="col-lg-6 mt-4 mt-lg-0">
					<div class="member d-flex align-items-start">
						<div class="pic">
							<img src="External/img/doctors/doctors-2.jpg" class="img-fluid"
								alt="">
						</div>
						<div class="member-info">
							<h4>Sarah Jhonson</h4>
				...
				<div class="col-lg-6 mt-4">
					<div class="member d-flex align-items-start">
						<div class="pic">
							<img src="External/img/doctors/doctors-3.jpg" class="img-fluid"
								alt="">
						</div>
						<div class="member-info">
				...
				<div class="col-lg-6 mt-4">
					<div class="member d-flex align-items-start">
						<div class="pic">
							<img src="External/img/doctors/doctors-4.jpg" class="img-fluid"
								alt="">
						</div>
						<div class="member-info">
							<h4>Amanda Jepson</h4>
			...
			<div class="row no-gutters">
				...
				<div class="col-lg-3 col-md-4">
					<div class="gallery-item">
						<a href="External/img/gallery/gallery-1.jpg"
							class="galelry-lightbox"> <img
							src="External/img/gallery/gallery-1.jpg" alt="" class="img-fluid">
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4">
					<div class="gallery-item">
						<a href="External/img/gallery/gallery-2.jpg"
							class="galelry-lightbox"> <img
							src="External/img/gallery/gallery-2.jpg" alt="" class="img-fluid">
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4">
					<div class="gallery-item">
						<a href="External/img/gallery/gallery-3.jpg"
							class="galelry-lightbox"> <img
							src="External/img/gallery/gallery-3.jpg" alt="" class="img-fluid">
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4">
					<div class="gallery-item">
						<a href="External/img/gallery/gallery-4.jpg"
							class="galelry-lightbox"> <img
							src="External/img/gallery/gallery-4.jpg" alt="" class="img-fluid">
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4">
					<div class="gallery-item">
						<a href="External/img/gallery/gallery-5.jpg"
							class="galelry-lightbox"> <img
							src="External/img/gallery/gallery-5.jpg" alt="" class="img-fluid">
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4">
					<div class="gallery-item">
						<a href="External/img/gallery/gallery-6.jpg"
							class="galelry-lightbox"> <img
							src="External/img/gallery/gallery-6.jpg" alt="" class="img-fluid">
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4">
					<div class="gallery-item">
						<a href="External/img/gallery/gallery-7.jpg"
							class="galelry-lightbox"> <img
							src="External/img/gallery/gallery-7.jpg" alt="" class="img-fluid">
						</a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4">
					<div class="gallery-item">
						<a href="External/img/gallery/gallery-8.jpg"
							class="galelry-lightbox"> <img
							src="External/img/gallery/gallery-8.jpg" alt="" class="img-fluid">
						</a>
					</div>
				</div>
						...
						<div class="email">
							...
							<p>
								<a href="/cdn-cgi/l/email-protection" class="__cf_email__"
									data-cfemail="8ce5e2eae3cce9f4ede1fce0e9a2efe3e1">[email&#160;protected]</a>
							</p>
						</div>
	...
	<!-- BootStrap Js -->
	<script src="External/customize/bootstrap/js/bootstrap.bundle.min.js"></script>
